...
public class CaronaRelampagoBusiness {
	...
	public void encerrarSistema() {
		for (CaronaRelampagoDomain caronaRelampago : interesseCaronasRelamlago) {
			try {
	...
	public String cadastrarCaronaRelampago(String idSessao, String origem,
		...
		carona.getCarona().setLocalDeOrigem(origem);
		carona.getCarona().setLocalDeDestino(destino);
		carona.getCarona().setData(dataIda);
		carona.getCarona().setQtdDeVagas(minimoCaroneiros);
		carona.getCarona().setIdSessao(idSessao);
		carona.getCarona().setHorario(hora);
...
//		System.out.println("Horas: " + h);
	...
	public String getAtributoCaronaRelampago(String idCarona, String atributo)
		...
		if (atributo.equals("origem")) {
			for (CaronaRelampagoDomain caronaRelampago : interesseCaronasRelamlago) {
				if (caronaRelampago.getIdCarona().equals(idCarona)) {
					return caronaRelampago.getCarona().getLocalDeOrigem() + "";
				} 
			}
		}
		if (atributo.equals("destino")) {
			for (CaronaRelampagoDomain caronaRelampago : interesseCaronasRelamlago) {
				if (caronaRelampago.getIdCarona().equals(idCarona)) {
					return caronaRelampago.getCarona().getLocalDeDestino() + "";
				}
			}
		}
		if (atributo.equals("minimoCaroneiros")) {
			for (CaronaRelampagoDomain caronaRelampago : interesseCaronasRelamlago) {
				if (caronaRelampago.getIdCarona().equals(idCarona)) {
					return caronaRelampago.getCarona().getQtdDeVagas() + "";
				}
			}
		}
		if (atributo.equals("dataIda")) {
			for (CaronaRelampagoDomain caronaRelampago : interesseCaronasRelamlago) {
				if (caronaRelampago.getIdCarona().equals(idCarona)) {
					return caronaRelampago.getCarona().getData() + "";
				}
			}
		}
	...
	public String getTrajeto(String idCarona) throws CaronaException {
		...
		for (CaronaRelampagoDomain caronaRelampago : interesseCaronasRelamlago) {
			if (caronaRelampago.getIdCarona().equals(idCarona)) {
				return caronaRelampago.getCarona().getLocalDeOrigem() + " - "
						+ caronaRelampago.getCarona().getLocalDeDestino();
			}
		}
		return null;
	}
	...
	public String getCaronaRelampago(String idCarona) throws CaronaException {
		...
		for (CaronaRelampagoDomain caronaRelampago : interesseCaronasRelamlago) {
			if (caronaRelampago.getIdCarona().equals(idCarona)) {
				return caronaRelampago.getCarona().getLocalDeOrigem()+ " para "
						+ caronaRelampago.getCarona().getLocalDeDestino() + ", no dia "
						+ caronaRelampago.getCarona().getData() + ", as "
						+ caronaRelampago.getCarona().getHorario();
			}
